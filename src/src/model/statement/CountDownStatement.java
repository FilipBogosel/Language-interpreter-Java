...
public record CountDownStatement(String variable) implements IStatement {
    ...
    public ProgramState execute(ProgramState state) {
        ...
        try {
            ...
            // Exam Rule: write into Out table the current prgState id
            state.outputList().add(new IntValue(state.id()));
